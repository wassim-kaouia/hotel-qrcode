...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('frontends', function (Blueprint $table) {
            ...
            $table->longText('description_s1')->nullable();
            $table->text('bg_header')->nullable();
            $table->text('bg_video')->nullable();
            $table->string('title_s2')->nullable();
            $table->longText('description_s2')->nullable();
            $table->string('title_icon1_s2')->nullable();
            $table->longText('description_icon1_s2')->nullable();
            $table->string('title_icon2_s2')->nullable();
            $table->longText('description_icon2_s2')->nullable();
            $table->string('title_icon3_s2')->nullable();
            $table->longText('description_icon3_s2')->nullable();
            $table->string('title_icon4_s2')->nullable();
            $table->longText('description_icon4_s2')->nullable();
            $table->string('title_s3')->nullable();
            $table->longText('description_s3')->nullable();
            ...
            $table->longText('description_s4')->nullable();
            $table->string('title_s5')->nullable();
            $table->longText('description_s5')->nullable();
