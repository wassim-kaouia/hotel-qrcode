...
<form action="{{ route('store.comment') }}" method="POST" enctype="multipart/form-data">
    @csrf
    {{-- section 1  --}}
    <p class="my-4">Les avis des clients</p>
    <div class="mb-6">

      <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nom du client</label>
      <input type="text" id="name" value="" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
    </div>

    <div class="mb-6">

        <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
        <input type="text" id="description" value="" name="description" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
      </div>
    ...
    <div class="mb-6">
        ...
        <div class="mt-4 ">
          ...
          {{-- <a href="{{ url('imagesApp/frontend/images/') }}"><img src="{{ url('imagesApp/frontend/images/') }}" alt="" class="w-32 rounded-lg">
          </a> --}}
      </div>
      </div>
