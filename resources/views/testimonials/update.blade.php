...
<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Mise à jour Des Avis') }} | <a href="{{ route('index.testimonials') }}" class="text-red-700">Ajouter un nouveau commentaire</a>
        </h2>
    </x-slot>
...
<form action="{{ route('update.comment') }}" method="POST" enctype="multipart/form-data">
    @csrf
    {{-- section 1  --}}
    <p class="my-4">L'avie d'un client</p>
    <div class="mb-6">

      <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nom du client</label>
      <input type="text" id="name" value="{{ $comment->name }}" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
    </div>

    <div class="mb-6">

        <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
        <input type="text" id="description" value="{{ $comment->description }}" name="description" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
      </div>
    ...
    <div class="mb-6">
        ...
        <div class="mt-4 ">
          ...
          <a href="{{ url('imagesApp/frontend/avatars/'.$comment->avatar) }}"><img src="{{ url('imagesApp/frontend/avatars/'.$comment->avatar) }}" alt="" class="w-32 rounded-lg">
          </a>
      </div>
      </div>
    ...
    <div class="mb-6">
        ...
        <textarea cols="3" id="comment" name="comment" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            {!! $comment->comment !!}
        </textarea>
    </div>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <td class="px-6 py-4">
                    <a href="{{ route('edit.comment',['id' => $comment->id]) }}"
