        ...
        <div class="row px-4">
            ...
            <div class="col-6 mb-4 p-2">
                <div class="mx-auto my-auto p-4 bg-light rounded d-flex flex-column">
                    <a class="text-center mb-2" style="color:black;" href="{{ route('arrounds.app',['interest' => $interest->id]) }}"><i class="fa fa-clock-o " style="font-size: 60px;" aria-hidden="true" ></i></a>
