    ...
    <div class="pt-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-1 gap-4">
                <div class="lg:col-span-1 md:col-span-2 bg-white overflow-hidden shadow-xl sm:rounded-lg relative">

                    <div class="grid lg:grid-cols-1 sm:grid-cols-1 md-cols-2 lg:gab-4 p-8">

                        <div>
                            <img class="absolute w-64 top-10 right-10" src="{{ asset('assets/images/bg-invoices.jpg') }}"
                                alt="">
                        </div>
