                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-6 d-flex justify-content-center mt-3 wifi_module" >
                        <div class="square-icon " style="background-color : {{ $app->setting->app_theme['background_color'] }}">
                            <img src="{{ url('imagesApp/images/icons/'.$app->setting->wifi_path) }}" class="icon icon d-block center-block" alt="" onclick="openWifi()">
                    ...
                    <div class="col-sm-6 col-6 d-flex justify-content-center mt-3">
                        <div class="square-icon " style="background-color : {{ $app->setting->app_theme['background_color'] }}">
                            <img src="{{ url('imagesApp/images/icons/'.$app->setting->digicode_path) }}" class="icon icon d-block center-block" alt="">
                    ...
                    <div class="col-sm-6 col-6 d-flex justify-content-center mt-3">
                        <div class="square-icon " style="background-color : {{ $app->setting->app_theme['background_color'] }}">
                            <img src="{{ url('imagesApp/images/icons/'.$app->setting->livre_path) }}" class="icon icon d-block center-block" alt="">
                    ...
                    <div class="col-sm-6 col-6 d-flex justify-content-center mt-3">
                        <div class="square-icon " style="background-color : {{ $app->setting->app_theme['background_color'] }}">
                            <img src="{{ url('imagesApp/images/icons/'.$app->setting->info_path) }}" class="icon icon d-block center-block" alt="">
                    ...
                    <div class="col-sm-6 col-6 d-flex justify-content-center mt-3">
                        <div class="square-icon " style="background-color : {{ $app->setting->app_theme['background_color'] }}">
                            <img src="{{ url('imagesApp/images/icons/'.$app->setting->numero_path) }}" class="icon icon d-block center-block" alt="">
