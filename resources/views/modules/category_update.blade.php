...
<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __("Les Categories") }}  :   <a style="color:green;" href="{{ route('interest.index') }}">Créer un nouveau point d'interet</a>
        </h2>
    </x-slot>
                    ...
                    <div class="grid lg:grid-cols-1 sm:grid-cols-1 md-cols-1 lg:gab-4 p-8">
                        <form action="{{ route('category.update')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" id="category" name="category" value="{{ $onecategory->title }}"
