            ...
            <div class="grid md:grid-cols-1 gap-4">
                <div class="lg:col-span-2 md:col-span-2 bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="grid lg:grid-cols-1 sm:grid-cols-1 md-cols-1 lg:gab-4 p-8">
                        <form action="{{ route('partenariat.create')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-6">
                                <label for="partenariat_name"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nom de Partenaire</label>
                                <input type="text" id="partenariat_name" name="partenariat_name"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="partenariat_website" placeholder="" name="partenariat_website"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                            required>
                        </div>
                        ...
                        {{-- <div class="mb-6">
                           <img src="{{ url('imagesApp/images/partenariats/'.Auth::user()->id.'/'.Auth::user()->) }}" alt="">
                        </div> --}}

                            
                        <button type="submit"
                                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Créer
                                le partenaire
                        </button>
                        </form>
