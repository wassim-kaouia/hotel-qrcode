                    ...
                    <div class="grid lg:grid-cols-4 sm:grid-cols-1 md-cols-2 lg:gab-4 p-8">
                        ...
                        <div class="bg-gray-100 shadow-md rounded-md w-40 h-40  mb-8">
                            <div class="p-4">
                                ...
                                <img src="{{ url('imagesApp/images/icons/'.$settingGeneral->digicode_path) }}" class="icon d-block center-block w-20 mx-auto">
                        ...
                        <div class="bg-gray-100 shadow-md rounded-md w-40 h-40  mb-8">
                            <div class="p-4">
                                ...
                                <img src="{{ url('imagesApp/images/icons/'.$settingGeneral->livre_path) }}" class="icon d-block center-block w-20 mx-auto">
                        ...
                        <div class="bg-gray-100 shadow-md rounded-md w-40 h-40  mb-8">
                            <div class="p-4">
                                ...
                                <img src="{{ url('imagesApp/images/icons/'.$settingGeneral->arround_path) }}" class="icon d-block center-block w-20 mx-auto">
                        ...
                        <div class="bg-gray-100 shadow-md rounded-md w-40 h-40  mb-8">
                            <div class="p-4">
                                ...
                                <img src="{{ url('imagesApp/images/icons/'.$settingGeneral->info_path) }}" class="icon d-block center-block w-20 mx-auto">
                        ...
                        <div class="bg-gray-100 shadow-md rounded-md w-40 h-40  mb-8">
                            <div class="p-4">
                                {{-- <i class="fa fa-volume-control-phone text-6xl flex justify-center"
                                    aria-hidden="true"></i> --}}
                                <img src="{{ url('imagesApp/images/icons/'.$settingGeneral->numero_path) }}" class="icon d-block center-block w-20 mx-auto">
                        ...
                        <div class="bg-gray-100 shadow-md rounded-md w-40 h-40  mb-8">
                            <div class="p-4">
                                {{-- <i class="fa fa-handshake-o text-6xl flex justify-center"
                                    aria-hidden="true"></i> --}}
                                <img src="{{ url('imagesApp/images/icons/'.$settingGeneral->partenariat_path) }}" class="icon d-block center-block w-20 mx-auto">
