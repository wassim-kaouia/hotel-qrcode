                        ...
                        <form action="{{ route('numeros.updates')}}" method="POST">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" id="numero_title"
                                    placeholder="Numero d'urgence Ex." value="{{ $onenumeros->title }}"
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" id="numero" placeholder="+351933454121 Ex." value="{{ $onenumeros->numero }}"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                    required>
                            </div>

      
                            <input type="hidden" value="{{ $onenumeros->id }}" name="wifi_id">
                            <button type="submit"
